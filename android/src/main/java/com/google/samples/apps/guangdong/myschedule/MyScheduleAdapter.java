...
package com.google.samples.apps.guangdong.myschedule;
...
public class MyScheduleAdapter implements ListAdapter, AbsListView.RecyclerListener {
    ...
    /** 将item的startTime、endTime、room，制作出startTime/endTime/room的形式 */
