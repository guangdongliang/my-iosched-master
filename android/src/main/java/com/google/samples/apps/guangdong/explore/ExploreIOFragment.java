...
package com.google.samples.apps.guangdong.explore;

import com.google.samples.apps.guangdong.R;
import com.google.samples.apps.guangdong.explore.data.ItemGroup;
import com.google.samples.apps.guangdong.explore.data.LiveStreamData;
import com.google.samples.apps.guangdong.explore.data.MessageData;
import com.google.samples.apps.guangdong.explore.data.SessionData;
import com.google.samples.apps.guangdong.explore.data.ThemeGroup;
import com.google.samples.apps.guangdong.explore.data.TopicGroup;
...
import com.google.samples.apps.guangdong.settings.ConfMessageCardUtils;
import com.google.samples.apps.guangdong.settings.SettingsUtils;
import com.google.samples.apps.guangdong.ui.widget.CollectionView;
import com.google.samples.apps.guangdong.ui.widget.CollectionViewCallbacks;
import com.google.samples.apps.guangdong.ui.widget.DrawShadowFrameLayout;
import com.google.samples.apps.guangdong.util.ImageLoader;
import com.google.samples.apps.guangdong.util.ThrottledContentObserver;
import com.google.samples.apps.guangdong.util.UIUtils;
import com.google.samples.apps.guangdong.util.WiFiUtils;
...
import static com.google.samples.apps.guangdong.settings.ConfMessageCardUtils.ConferencePrefChangeListener;
...
public class ExploreIOFragment extends Fragment implements UpdatableView<ExploreModel>,
    ...
    public void onAttach(Activity activity) {
        ...
        /** Register preference change listeners，全监测 */
