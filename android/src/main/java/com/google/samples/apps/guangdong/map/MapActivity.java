...
import com.google.samples.apps.guangdong.session.SessionDetailConstants;
...
/**
 * Activity that displays a {@link com.google.samples.apps.guangdong.map.MapFragment} and a {@link
 * com.google.samples.apps.guangdong.map.MapInfoFragment}.
 ...
 * marker.
 *
 * @see com.google.samples.apps.guangdong.map.MapInfoFragment#newInstace(android.content.Context)
 */
public class MapActivity extends BaseActivity
     ...
     * applied to the map.
     *
     * For {@link com.google.samples.apps.guangdong.map.InlineInfoFragment} (that is only displayed
     * on the left of the screen), the full extend of its container layout (including padding) is
     * passed to the map fragment.
     * For {@link com.google.samples.apps.guangdong.map.SlideableInfoFragment} (that is only
     * displayed
