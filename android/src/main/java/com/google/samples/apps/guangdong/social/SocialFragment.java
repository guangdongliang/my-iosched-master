...
package com.google.samples.apps.guangdong.social;
...
import com.google.samples.apps.guangdong.social.SocialModel.SocialLinksEnum;
...
public class SocialFragment extends Fragment {
     ...
     * 为最上边的g+和Twitter添加点击事件、
     * 为两个developer的textView添加点击事件、
     * 为中间的添加点击事件
     * 为下边的添加点击事件
     */
    ...
    /** 使OptionMenu无效、为main_content添加上方空间 */
    @Override
