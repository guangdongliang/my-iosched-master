...
import com.google.samples.apps.guangdong.io.map.model.MapData;
import com.google.samples.apps.guangdong.io.map.model.Marker;
import com.google.samples.apps.guangdong.io.map.model.Tile;
...
public class MapPropertyHandler extends JSONHandler {
    ...
    /** 将mapTitles的key和value加入mTileOverlays中 */
    ...
    /** 将markers加入mMarkers，key相同的加入同一个value 也就是(ArrayList<Marker>())中 */
    ...
    /** 先删除MapMarkers，再将mMarkers的数据添加到MapMarkers DB中 */
    ...
    /** 先删除 MapTiles表内容，将mTileOverlays中的数据添加到 MapTiles DB 中 */
