...
public class SelectionBuilder {
     ...
     * 将参数selection、selectionArgs分别添加到本类的mSelection和mSelectionArgs中
     */
    public SelectionBuilder where(String selection, String... selectionArgs) {
        ...
        Arrays.sort(new String[]{"a","ad","ert"});
        return this;
    }
    ...
    /**
     * 转换成(column,table.column)形式的map
     * @param column
     * @param table
     * @return
     */
