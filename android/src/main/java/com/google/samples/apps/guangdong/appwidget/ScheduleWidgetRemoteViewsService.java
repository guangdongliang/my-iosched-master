...
package com.google.samples.apps.guangdong.appwidget;
...
import com.google.samples.apps.guangdong.model.ScheduleItem;
...
import com.google.samples.apps.guangdong.ui.SimpleSectionedListAdapter;
import com.google.samples.apps.guangdong.ui.TaskStackBuilderProxyActivity;
...
public class ScheduleWidgetRemoteViewsService extends RemoteViewsService {
    ...
    private static class WidgetRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
        ...
        /** 获得position上的ScheduleItem的type，是“正在开会”、“还未开始” */
