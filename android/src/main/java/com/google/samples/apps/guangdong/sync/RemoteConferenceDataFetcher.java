...
import com.google.samples.apps.guangdong.io.model.DataManifest;
import com.google.samples.apps.guangdong.util.HashUtils;
...
public class RemoteConferenceDataFetcher {
     ...
     * 获得服务器上清单文件的URL，该URL可以是BuildConfig中的，也可以是配置的文件中的
     ...
     *
     * 利用URL从cache或者网络上获取文件,如果cache文件可用，则读取他，不可用则从网上下载
     *
    ...
    /** Delete unnecessary files from our cache，删除老的没有必要的缓存  */
