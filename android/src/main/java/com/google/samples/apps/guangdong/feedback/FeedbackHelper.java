...
import com.google.samples.apps.guangdong.feedback.SessionFeedbackModel.SessionFeedbackData;
...
public class FeedbackHelper {
     ...
     * 将data中的SessionFeedbackData数据保存在ContentProvider中
     */
     ...
     * 从SharedPreferences中获得sessionId是否已经被触发
     */
     ...
     * 将SharedPreferences中的sessionId设置为触发状态
     */
     ...
     * 将DataMap数据解析为SessionFeedbackData对象
