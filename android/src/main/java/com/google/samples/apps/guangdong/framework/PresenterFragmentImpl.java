...
public class PresenterFragmentImpl extends Fragment
    ...
    public void setUpdatableView(UpdatableView view) {
        mUpdatableView = view;
        /** 将本类中的onUserAction加入到ExploreIOFragment中 */
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        /** 将cursorLoader加入到LoaderIdlingResource中，开始监视加载 */
        mLoaderIdlingResource.onLoaderStarted(cursorLoader);
        return cursorLoader;
    }
    /** 利用Model创建相应的CursorLoader */
    @VisibleForTesting
