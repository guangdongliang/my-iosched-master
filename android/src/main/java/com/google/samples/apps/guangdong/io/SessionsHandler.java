...
package com.google.samples.apps.guangdong.io;
...
import com.google.samples.apps.guangdong.io.model.Session;
import com.google.samples.apps.guangdong.io.model.Speaker;
import com.google.samples.apps.guangdong.io.model.Tag;
...
import com.google.samples.apps.guangdong.provider.ScheduleDatabase;
...
public class SessionsHandler extends JSONHandler {
    ...
    public void makeContentProviderOperations(ArrayList<ContentProviderOperation> list) {
        ...
        for (Session session : mSessions.values()) {
            ...
            if (!incrementalUpdate || !sessionHashCodes.containsKey(session.id) ||
                ...
                /** add relationships to speakers and track，相当于关系表 */
    ...
    /** 产生删除对应sessionId的ContentProviderOperation  */
    ...
    /** 从DB中提取Sessions的HashCodes，产生(sessionId,hashcode)的Map  */
    ...
    /** 根据isInsert决定 Insert或Update，然后建立ContemtProviderOperation，并加入list中 */
    private void buildSession(boolean isInsert,
        ...
        /** 根据session.speakers建立speakerNames，中间用逗号隔开 */
        String speakerNames = "";
        if (mSpeakerMap != null) {
    ...
    /** 利用session的tags，从mTags中取出相应的Tags，然后取出对应的最小的order_in_category */
    ...
    /** 向Session Speakers DB中插入数据，相当于关系表  */
