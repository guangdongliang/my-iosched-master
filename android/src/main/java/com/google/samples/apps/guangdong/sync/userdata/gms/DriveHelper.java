 ...
 */
package com.google.samples.apps.guangdong.sync.userdata.gms;
...
import com.google.samples.apps.guangdong.util.IOUtils;
...
public class DriveHelper {
     ...
     * 利用已经连接的apiClient闯将DriveHelper的对象
     *
     ...
     * 阻塞连接，如果已经连接则返回null，如果失败，mGoogleApiClient定义的地方有Callback
     ...
     * 根据fileName、mimeType从服务器获取DriveId
     ...
     * 利用fileName和mimeType在AppFolder中创建文件
    ...
    private DriveId createEmptyDriveFile(String fileName, String mimeType) {
        ...
        DriveFolder.DriveFileResult driveFileResult = Drive.DriveApi.getAppFolder(mGoogleApiClient)/** 获得的是在AppFolder中创建文件 */
     ...
     * 从Drive上获取AppFloder上的用户数据的DriveId
