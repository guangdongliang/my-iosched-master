...
package com.google.samples.apps.guangdong.ui;
...
import com.google.samples.apps.guangdong.AppApplication;
import com.google.samples.apps.guangdong.BuildConfig;
import com.google.samples.apps.guangdong.R;
import com.google.samples.apps.guangdong.about.AboutActivity;
import com.google.samples.apps.guangdong.debug.DebugActivity;
import com.google.samples.apps.guangdong.explore.ExploreIOActivity;
import com.google.samples.apps.guangdong.framework.Model;
import com.google.samples.apps.guangdong.framework.PresenterFragmentImpl;
import com.google.samples.apps.guangdong.framework.QueryEnum;
import com.google.samples.apps.guangdong.framework.UpdatableView;
import com.google.samples.apps.guangdong.framework.UserActionEnum;
import com.google.samples.apps.guangdong.gcm.ServerUtilities;
import com.google.samples.apps.guangdong.map.MapActivity;
import com.google.samples.apps.guangdong.myschedule.MyScheduleActivity;
import com.google.samples.apps.guangdong.provider.ScheduleContract;
import com.google.samples.apps.guangdong.service.DataBootstrapService;
import com.google.samples.apps.guangdong.settings.SettingsActivity;
import com.google.samples.apps.guangdong.settings.SettingsUtils;
import com.google.samples.apps.guangdong.social.SocialActivity;
import com.google.samples.apps.guangdong.sync.SyncHelper;
import com.google.samples.apps.guangdong.ui.widget.MultiSwipeRefreshLayout;
import com.google.samples.apps.guangdong.ui.widget.NavDrawerItemView;
import com.google.samples.apps.guangdong.ui.widget.ScrimInsetsScrollView;
import com.google.samples.apps.guangdong.util.AccountUtils;
import com.google.samples.apps.guangdong.util.ImageLoader;
import com.google.samples.apps.guangdong.util.LUtils;
import com.google.samples.apps.guangdong.util.LoginAndAuthHelper;
import com.google.samples.apps.guangdong.util.RecentTasksStyler;
import com.google.samples.apps.guangdong.util.TimeUtils;
import com.google.samples.apps.guangdong.util.UIUtils;
import com.google.samples.apps.guangdong.videolibrary.VideoLibraryActivity;
...
public abstract class BaseActivity extends AppCompatActivity implements
    ...
    /** 没有继承BaseActivity的activity不需要有drawer */
    ...
    /** 设置Swipe的刷新事件、Callback，只有MySchule页面中有 */
    ...
    /** 只有MySchule中有，设置progressBarTop出现的时候上边的尺寸 */
    ...
    /** 从服务器下载数据进行DB同步，只有MySchedule才会同步 */
    ...
    public static void navigateUpOrBack(Activity currentActivity,
        ...
        /** 合成Synthesize the parent activity when a natural one doesn't exist. */
        if (intent == null && syntheticParentActivity != null) {
            try {
                /** 从syntheticParentActivity取出parent作为本activity的parent */
    ...
    private void onNavDrawerItemClicked(final int itemId) {
        ...
        if (isSpecialItem(itemId)) {
            ...
            /** fade out the main content，先把主内容变没了 */
            View mainContent = findViewById(R.id.main_content);
            if (mainContent != null) {
    ...
    /** LoginAndAuthHelper.Callback中的方法 */
    @Override
    ...
    public void onAuthSuccess(String accountName, boolean newlyAuthenticated) {
        ...
        LOGD(TAG, "onAuthSuccess, account " + accountName + ", newlyAuthenticated="
                + newlyAuthenticated);
        /** 通知MySchedule、MyViewedVideos、MyFeedbackSubmitted已经改变 */
    ...
    private void onMainContentScrolled(int currentY, int deltaY) {
        ...
        boolean shouldShow = /** scroll在开始位置的时候 */currentY < mActionBarAutoHideMinY ||
                /** 向下滑动超过某个值的时候 */(mActionBarAutoHideSignal <= -mActionBarAutoHideSensivity);
    ...
    protected void enableActionBarAutoHide(final ListView listView) {
        ...
        listView.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount,
                ...
                //Log.d("dongdong  ", Integer.toString(previousItemsHeight)+"    -   "+Integer.toString(firstVisibleItemView.getTop())+"  +  "+Integer.toString(view.getPaddingTop()));
    ...
    private void registerGCMClient() {
        /** 方法用来验证设备是否支持GCM，如果不支持会抛出异常 */
        GCMRegistrar.checkDevice(this);
        /** 验证程序的manifest包含了在开始编写Android程序中所有符合要求的描述
         * （这个方法只有你在开发程序的时候需要；一旦这个程序准备发布的时候，你就可以把它移除掉）。 */
        ...
        if (TextUtils.isEmpty(regId)) {
            ...
            /** 调用com.google.android.gsf中的类进行注册，然后再GCMIntentService中的onRegistered中发送给服务器 */
            ...
            if (ServerUtilities.isRegisteredOnServer(this, gcmKey)) {
                ...
                mGCMRegisterTask = new AsyncTask<Void, Void, Void>() {
                    ...
                    protected Void doInBackground(Void... params) {
                        ...
                        /** 利用http post 在server端注册tegId、gcmKey */
    ...
    /** 改变mHideableHeaderViews中注册的View的显示状态 */
    protected void onActionBarAutoShowOrHide(boolean shown) {
        ...
        mStatusBarColorAnimator = ObjectAnimator.ofInt(
                ...
                shown ? Color.RED : mNormalStatusBarColor,
                shown ? mNormalStatusBarColor : Color.RED)
                .setDuration(250);
        if (mDrawerLayout != null) {
    ...
    /**
     * Adds a {@link com.google.samples.apps.guangdong.framework.PresenterFragmentImpl} to the
     * Activity if required, and sets it up with the {@code model}, {@code queries},
     * {@code actions} and the {@link com.google.samples.apps.guangdong.framework.UpdatableView}
     * corresponding to the {@code updatableViewResId}.
     *
     * @return the {@link com.google.samples.apps.guangdong.framework.PresenterFragmentImpl},
     */
    public PresenterFragmentImpl addPresenterFragment(int updatableViewResId, Model model, QueryEnum[] queries,
        ...
        /** Check if the presenter fragment is already present (ie if the activity is recreated due to orientation change). */
     ...
     * {@link com.google.samples.apps.guangdong.util.ThrottledContentObserver} for the given
