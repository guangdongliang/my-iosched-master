...
import com.google.samples.apps.guangdong.util.ParserUtils;
...
public class VideoLibraryModel implements Model {
    ...
    /**
     * 利用args中的KEY_YEAR,KEY_TOPIC创造查找的CursorLoader
     * @param loaderId
     * @param uri
     * @param args
     * @return
    ...
    public Loader<Cursor> createCursorLoader(int loaderId, Uri uri, @Nullable Bundle args) {
        ...
        /** 用VIDEO_YEAR和VIDEO_TOPIC作为条件产生CursorLoader */
