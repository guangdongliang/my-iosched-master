...
public class TagMetadata {
    ...
    /** 从cursor中提取出Tag，分别加入mTagById和mTagsInCategory中 */
    public TagMetadata(Cursor cursor) {
        ...
        for(int i = 0; i < count; i ++){
            ...
            /** 将具有相同category的tag保存在同一个value中   HashMap<String, ArrayList<Tag>> */
    ...
    /** 根据tagId，从Map---mTagsById中返回Tag */
    public Tag getTag(String tagId) {
        return mTagsById.containsKey(tagId) ? mTagsById.get(tagId) : null;
    }
    /** 根据category，从Map----mTagsInCategory中返回List<Tag> */
