...
public class ScheduleDatabase extends SQLiteOpenHelper {
    ...
    interface Tables {
        ...
        /** sessions左联接myschedule、rooms、sessions_tags */
        ...
        /** sessions左联接myschedule、rooms、sessions_tags、feedback */
        ...
        /** sessions左联接myschedule、rooms */
        String SESSIONS_JOIN_ROOMS = "sessions "
                + "LEFT OUTER JOIN myschedule ON sessions.session_id=myschedule.session_id "
                + "AND myschedule.account_name=? "
                + "LEFT OUTER JOIN rooms ON sessions.room_id=rooms.room_id";

        /** sessions_speakers左联接speakers */
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + Tables.SESSIONS + " ("
                ...
                + Sessions.ROOM_ID + " TEXT " + References.ROOM_ID + "," /** 外键 */
        ...
        db.execSQL("CREATE VIRTUAL TABLE " + Tables.SESSIONS_SEARCH + " USING fts3("
                ...
                + "tokenize=porter)");
        /** Simple根据空格和标点符号将文本分解成不同的记号。Porter是专为英文使用而设计，它可以将大量的文字扩展化解为基础形式。
