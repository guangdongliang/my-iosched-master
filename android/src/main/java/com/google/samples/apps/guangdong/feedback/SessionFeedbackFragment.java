...
import com.google.samples.apps.guangdong.ui.widget.NumberRatingBar;
...
public class SessionFeedbackFragment extends Fragment
    ...
    /** 为mOverallFeedbackBar，也就是RatingBar设置可接近的；
     *  为RatingBar改变设置时间，比如读出来
     *  为最下边的按钮设置提交事件
     * */
    @Override
    ...
    /** 把listeners中的每个UserActionListener都响应一遍 */
    ...
    /** 利用SessionFeedbackModel中的数据将mTitle与mSpeakers控件填充信息 */
    @Override
