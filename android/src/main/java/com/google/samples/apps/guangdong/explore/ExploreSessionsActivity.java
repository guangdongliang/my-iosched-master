...
import com.google.samples.apps.guangdong.ui.SearchActivity;
...
import static com.google.samples.apps.guangdong.ui.widget.CollectionView.Inventory;
import static com.google.samples.apps.guangdong.ui.widget.CollectionView.InventoryGroup;
import static com.google.samples.apps.guangdong.ui.widget.CollectionView.OnClickListener;
...
public class ExploreSessionsActivity extends BaseActivity
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        /** 将CollectionView与ActionBar的隐藏相关联 */
    ...
    private void onTagMetadataLoaded() {
        if (mTagFilterHolder == null) {
            ...
            /** 将intent自带的tag加入TagFilterHolder中 */
            ...
            // (i.e. Sessions, code labs, sandbox, misc).全部是Type的
            ...
            if (titleTag != null &&
                ...
                for (String tagId : mTagFilterHolder.getSelectedFilters()) {
                    ...
                    if (TextUtils.equals(titleTag.getCategory(), theTag.getCategory())) {
                        /** 做了这没多，只为获得Tag的Name */
                        /** 防止activity进去之后点击checkBox时，title文不对题 */
     ...
     * {@link com.google.samples.apps.guangdong.model.TagMetadata}
     * 右边的drawer的adapter
     */
