...
import com.google.samples.apps.guangdong.provider.ScheduleContract.Announcements;
import com.google.samples.apps.guangdong.provider.ScheduleContract.Blocks;
import com.google.samples.apps.guangdong.provider.ScheduleContract.Feedback;
import com.google.samples.apps.guangdong.provider.ScheduleContract.HashtagColumns;
import com.google.samples.apps.guangdong.provider.ScheduleContract.Hashtags;
import com.google.samples.apps.guangdong.provider.ScheduleContract.MapMarkers;
import com.google.samples.apps.guangdong.provider.ScheduleContract.MapTiles;
import com.google.samples.apps.guangdong.provider.ScheduleContract.MyFeedbackSubmitted;
import com.google.samples.apps.guangdong.provider.ScheduleContract.MySchedule;
import com.google.samples.apps.guangdong.provider.ScheduleContract.MyScheduleColumns;
import com.google.samples.apps.guangdong.provider.ScheduleContract.MyViewedVideos;
import com.google.samples.apps.guangdong.provider.ScheduleContract.Rooms;
import com.google.samples.apps.guangdong.provider.ScheduleContract.SearchSuggest;
import com.google.samples.apps.guangdong.provider.ScheduleContract.SearchTopicsSessions;
import com.google.samples.apps.guangdong.provider.ScheduleContract.Sessions;
import com.google.samples.apps.guangdong.provider.ScheduleContract.Speakers;
import com.google.samples.apps.guangdong.provider.ScheduleContract.Tags;
import com.google.samples.apps.guangdong.provider.ScheduleContract.VideoColumns;
import com.google.samples.apps.guangdong.provider.ScheduleContract.Videos;
import com.google.samples.apps.guangdong.provider.ScheduleDatabase.SessionsSearchColumns;
import com.google.samples.apps.guangdong.provider.ScheduleDatabase.SessionsSpeakers;
import com.google.samples.apps.guangdong.provider.ScheduleDatabase.Tables;
...
import com.google.samples.apps.guangdong.util.SelectionBuilder;
...
import static com.google.samples.apps.guangdong.util.LogUtils.LOGV;
 ...
 * usually inserted by {@link com.google.samples.apps.guangdong.sync.SyncHelper}, and queried using
...
public class ScheduleProvider extends ContentProvider {
     ...
     * parameter is used by the {@link com.google.samples.apps.guangdong.explore.ExploreSessionsActivity}
        ...
        switch (matchingUriEnum) {
            ...
            case SEARCH_TOPICS_SESSIONS: {
                ...
                Cursor tags = query(Tags.CONTENT_URI, SearchTopicsSessions.TOPIC_TAG_PROJECTION,
                        ...
                        new String[] {Config.Tags.CATEGORY_TOPIC, selectionArg + "%"},/** 百分号（%）代表零个、一个或多个数字或字符。下划线（_）代表一个单一的数字或字符*/
     ...
     * {@link com.google.samples.apps.guangdong.sync.ConferenceDataHandler} notifies all top level
     * conference paths once the conference data sync is done, and the
     * {@link com.google.samples.apps.guangdong.sync.userdata.AbstractUserDataSyncHelper} notifies all
    ...
    /** 从uri中得到accountName，并根据boolean确定是否需要替换accountName中的"'" */
