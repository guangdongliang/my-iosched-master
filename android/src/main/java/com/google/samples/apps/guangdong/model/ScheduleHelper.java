...
import com.google.samples.apps.guangdong.myschedule.MyScheduleAdapter;
...
public class ScheduleHelper {
     ...
     * 将DB中在dayStart与dayEnd之间的取出，并加入所有是free的ScheduleItem的numOfSessions中，并剔除是free且已经开始的ScheduleItem
     */
    ...
    /** 将DB中在start与end之间的sessions加入immutableItems中 */
    ...
    /** 将DB中在start 与 end之间的Blocks根据是否free分别加入mutableItems与immutableItems中 */
